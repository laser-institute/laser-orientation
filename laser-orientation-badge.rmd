...
Welcome to your first Learning Lab Case Study! This case study is really
a warm-up activity to introduce you to R Markdown and the data-intensive
research workflow, both of which are heavily integrated into each LASER
Learning Labs. [R Markdown](https://rmarkdown.rstudio.com/) documents
weave together narrative text and code to produce both static and
dynamic outputs for sharing your research.

You may have used R Markdown before - or you may not have! Either is
fine as this task will be designed with the assumption that you have not
used R before. In the context of doing so, we'll focus on the following
tasks:
...
or model, for what we mean by using learning analytics in STEM education
research.

This framework is called the data-intensive research workflow and comes
from the work of Krumm et al.'s [*Learning Analytics Goes to
...
that this document and all of our LASER Labs case studies are organized
