...
Welcome to your first Learning Lab Case Study! Case study activities
demonstrate how key data-intensive research workflow processes (i.e.,
wrangling, visualizing, summarizing, modeling, and communicating data)
featured in exemplary STEM education research studies are implemented in
R. Case studies also provide a holistic setting to explore important
foundational LA topics integral to data analysis such as reproducible
research, use of APIs, student privacy, ethical consideration, and
diversity and inclusion in STEM education.

This introductory case study is really just a warm-up activity to
...
2.  Second, "Knit" next to the yarn ball at the top of this screen to
    preview the document as you work through it. This will allow you to
...
3.  Finally, note the specially formatted text box below containing some
    {r} code and its own set of buttons. This is called a "[code
    ...
    including R, Python, and SQL directly in your document. Click the
    green arrow button on the right side of the code chunk to run the R
    code and view the one of the images stored in the `img` folder in
    your files pane.
...
framework called the data-intensive research workflow and comes from the
work of Krumm et al.'s [*Learning Analytics Goes to
School*](#0){style="font-size: 11.4pt;"}*.* You can check that out, but
don't feel any need to dive deep for now - we'll be spending more time
on this throughout the week. For now, know that this document and all of
our LASER Labs case studies are organized around these five components.
