...
activities included in each learning lab demonstrate how key
data-intensive research workflow processes as featured in exemplary STEM
education research studies can be implemented in R. Case studies also
provide a holistic setting to explore important foundational topics
integral to Learning Analytics such as reproducible research, use of
APIs, and ethical use of educational data.
...
and `TimeSpent` (i.e., the number of minuutes they spent in the course's
