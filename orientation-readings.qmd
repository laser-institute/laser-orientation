...
Read chapters 1 and 2 of [Reproducible Research with R and RStudio](https://github.com/christophergandrud/Rep-Res-Book) by Christopher Gandrud The following readings for this module provide an introduction to Reproducible Research, Learning Analytics and the data-intensive research cycle, and using R for data science in education:
