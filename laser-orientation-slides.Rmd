...
The data is from a research study that utilized a number of different data sources (surveys, LMS log data, gradebooks, etc.) to understand students' motivation in online courses. 
]
